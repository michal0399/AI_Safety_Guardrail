...
def test_valid_person_name_masking(safety_guardrail):
    ...
    test_cases = ["John Wick", "Jane Doe", "Dr. Robert Smith", "María García"]
...
def test_valid_phone_masking(safety_guardrail):
    ...
    test_cases = ["555-123-4567", "(555) 123-4567", "+1-555-123-4567", "555.123.4567"]
...
def test_valid_date_masking(safety_guardrail):
    ...
    test_cases = ["01/15/1990", "January 15, 1990", "2023-12-25", "Dec 25, 2023"]
